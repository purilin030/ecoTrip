        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <form action="" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <label for="challenge_id" class="block text-sm font-medium text-gray-700">Select Challenge</label>
                        <select id="challenge_id" name="challenge_id" required class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-brand-500 focus:border-brand-500 sm:text-sm rounded-md">
                            <option value="" selected disabled>-- Pick a challenge --</option>
                            <?php
                            // 确保表名是 challenge 还是 challenges，原代码是 challenge
                            ...
                            if ($c_result && $c_result->num_rows > 0) {
                                while ($row = $c_result->fetch_assoc()) {
                                    echo "<option value='" . $row['Challenge_ID'] . "'>" . $row['Title'] . " (" . $row['Points'] . " pts)</option>";
                                }
                            }
                            ?>
                        </select>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:bg-gray-50 transition">
                            <div class="space-y-1 text-center w-full">
                                ...
                                <img id="preview" src="#" alt="Image Preview" class="mx-auto h-64 object-contain rounded-md hidden mb-4">
                                ...
                                <div id="upload-placeholder">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label for="photoInput" class="relative cursor-pointer bg-white rounded-md font-medium text-brand-600 hover:text-brand-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-brand-500">
                                            <span>Upload a file</span>
                                            <input id="photoInput" name="photo" type="file" class="sr-only" accept="image/png, image/jpeg" required onchange="previewImage(this)">
                                        </label>
                                ...
                                <div class="mt-2 text-xs text-blue-600 bg-blue-50 py-1 px-2 rounded inline-block">
                                    <i class="fa-solid fa-shield-halved mr-1"></i> Anti-Cheat: Duplicate photos will be rejected.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="caption" name="caption" rows="3" required class="shadow-sm focus:ring-brand-500 focus:border-brand-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Describe your activity..."></textarea>
                        </div>
                    </div>

                    <div class="flex justify-end gap-3 pt-2">
                        <a href="../index.php" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500">
                            Cancel
                        </a>
                        <button type="submit" class="inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-brand-600 hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500">
                            Submit for Review
                        </button>
                    </div>

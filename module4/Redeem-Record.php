...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-8">
            <a href="Marketplace.php" class="inline-flex items-center text-sm font-bold text-gray-500 hover:text-brand-600 transition group">
                <div class="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center mr-2 shadow-sm group-hover:border-brand-300 group-hover:text-brand-600">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-gray-500 mt-2">Track the status of your rewards.</p>
            </div>
